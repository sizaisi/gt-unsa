...
class ExpedienteController extends Controller
{
    public function index()
    {
        ...
        ->leftjoin('gt_grado_modalidades', 'gt_grado_modalidades.id', '=', 'gt_procedimientos.idgradomodalidad')
        ...
        'actescu.nesc as escuela', 'gt_procedimientos.nombre as procedimiento', 'gt_grado_modalidades.componente as modalidadobtencion',
