...
export default {
  ...
  created() {
    this.totalRows = this.procedimientos.length;
  },
  methods: {
    eliminar(procedimiento) {
      if (!confirm("Estas seguro de querer eliminar este procedimiento?"))
        return;
      this.$inertia.delete(
        `${this.api_url}/procedimientos/${procedimiento.id}`
      );
    },
    restaurar(procedimiento) {
      if (!confirm("Estas seguro de querer restaurar este procedimiento?"))
        return;
      this.$inertia.post(
        `${this.api_url}/procedimientos/${procedimiento.id}/restore`
      );
    },
