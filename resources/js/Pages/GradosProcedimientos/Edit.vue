  ...
  <app-layout>
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Editar Grado-Procedimiento</h3>
      </div>
      <div class="card-body">
...
export default {
  name: "gradosprocedimientos.edit",
  props: ["gradoprocedimiento"],
  components: {
    AppLayout,
  },
  data() {
  ...
  methods: {
    actualizar() {
      this.$inertia.put(`/gradosprocedimientos/${this.gradomodalidad.id}`, this.gradomodalidad);
    },
        ...
        console.log(response.data);
          ...
          if (this.select_modalidades.length == 0) {
            ...
            for(var gt of this.modalidades){
              this.select_modalidades.push({value: gt.id, text: gt.idgrado});
            }
          }       
      })
    },
      ...
      axios.get(`/getroles`)
        ...
        console.log(response.data);
          ...
          if (this.select_roles.length == 0) {
            this.select_roles.push({value: 0, text: 'Sin Modadlidad'});
