  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../dashboard" class="brand-link">
      <img
        ...
        style="opacity: 0.8"
      />
      <span class="brand-text font-weight-light">SISGRAD</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        >
          <li class="nav-header has-treeview">ADMINISTRACIÓN</li>
          <li class="nav-item">
            <jet-nav-link
          ...
          <li class="nav-header has-treeview">OFICINA GRADOS Y TÍTULOS</li>
          <li class="nav-item">
            <jet-nav-link
              :href="`${api_url}/colaciones`"
              type="link"
              :active="$page.currentRouteName == 'colaciones.index'"
              ><i class="nav-icon fas fa-bezier-curve"></i> Colaciones
            </jet-nav-link>
          </li>
          <li class="nav-item">
            <jet-nav-link
              ...
              ><i class="nav-icon fas fa-bezier-curve"></i> Revisión de
              Expediente
            </jet-nav-link>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-header has-treeview">MANTENIMIENTO</li>
          <li class="nav-item">
            <jet-nav-link
